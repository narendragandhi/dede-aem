...
public class OsgiManifestParser implements ProjectParser {
    ...
    public com.dede.domain.cache.BundleMetadata parseFromManifestObject(Manifest manifest, String location) {
        ...
        com.dede.domain.cache.BundleMetadata metadata = new com.dede.domain.cache.BundleMetadata(
    ...
    public CodeNode buildGraphFromMetadata(com.dede.domain.cache.BundleMetadata metadata, String location) {
