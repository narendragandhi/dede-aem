...
public class JarScanner {
    ...
    private final com.dede.domain.cache.MetadataCache cache;

    public JarScanner(OsgiManifestParser manifestParser, OsgiServiceParser serviceParser, com.dede.domain.cache.MetadataCache cache) {
    ...
    public void scan(Path jarPath) {
        ...
        try (JarFile jarFile = new JarFile(jarPath.toFile())) {
            ...
            var fullMetadata = new com.dede.domain.cache.BundleMetadata(
